...
*/
    ...
    public void up(int currentFloor, int finalFloor, int numberLift) throws InterruptedException {
    ...
    public void down(int currentFloor, int finalFloor, int numberLift) throws InterruptedException {
        int difference=Math.abs(currentFloor-finalFloor);
        int moveFloor=finalFloor*(-90);
